...
import org.opengroup.osdu.odatadms.provider.interfaces.IFileCollectionLocationProvider;
...
@Service
@RequestScope
public class FileCollectionLocationProviderImpl implements IFileCollectionLocationProvider {
	...
	@Override
	public FileCollectionUploadLocation getUploadLocation() {
		...
		FileCollectionUploadLocation uploadLocation = new FileUploadLocationIBMImpl(unsignedUrl,Instant.now(),credentials,region);
